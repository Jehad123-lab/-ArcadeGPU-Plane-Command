...
const App = () => {
    ...
    return (
        <div className="fixed inset-0 w-full h-full pointer-events-none flex flex-col justify-end p-8 overflow-hidden font-sans">
            ...
            <div className="absolute top-8 left-8 pointer-events-auto flex justify-between w-[calc(100vw-4rem)]">
                <div>
                    <h1 className="text-4xl font-bebas text-white drop-shadow-lg tracking-wider">AERO COMMAND</h1>
                    <div className="bg-black/20 backdrop-blur-sm p-3 rounded-lg border border-white/5 mt-2 max-w-sm">
                        <p className="text-white/80 text-xs font-bold uppercase tracking-tighter mb-1">Controls</p>
                        <p className="text-white/60 text-[11px] font-mono leading-tight">WASD • MOVE PLANE</p>
                        <p className="text-white/60 text-[11px] font-mono leading-tight">SPACE • FIRE</p>
                        <p className="text-white/60 text-[11px] font-mono leading-tight">L CLICK • FIRE</p>
                    </div>
                </div>
                <div className="text-right">
                    <p className="text-white/80 text-xs font-bold uppercase tracking-tighter mb-1">SCORE</p>
                    <h2 className="text-6xl font-bebas text-white drop-shadow-lg tracking-wider">{score.toString().padStart(6, '0')}</h2>
                </div>
            </div>
            ...
            <div className="pointer-events-auto flex justify-between items-end w-full pb-8">
                ...
                <div className="flex flex-col items-end gap-2">
                    ...
                    <div className="text-white/40 text-xs font-mono uppercase mt-4">Version 0.3-Plane</div>
                </div>
            </div>
